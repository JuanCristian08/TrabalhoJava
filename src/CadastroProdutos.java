...
public class CadastroProdutos {
    // Listas paralelas para armazenar nomesProdutos e preços dos produtos
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            System.out.println("7 - Atualizar o preço de um produto");
            ...
            switch (opcao) {
                    ...
                    if (precosProdutos.size() > 0) {
                        ...
                        for (int i = 0; i < precosProdutos.size(); i++) {
                            if (precosProdutos.get(i) > maiorPreco) {
                                ...
                                nomeProdutoMaisCaro = nomesProdutos.get(i);
                            }
                        }
                ...
                case 4:
                    if (precosProdutos.size() > 0) {
                        double soma = 0;
                        for (double precoProdutos : precosProdutos) {
                            soma += precoProdutos;
                        }
                        double media = soma / precosProdutos.size();
                        System.out.printf("Média de preço dos produtos: R$%.2f%n", media);
                    } else {
                        System.out.println("Nenhum produto cadastrado.");
                    }
                    break;
                ...
                case 5:
                    if (precosProdutos.size() > 0) {
                        double soma = 0;
                        for (double precoProduto : precosProdutos) {
                            soma += precoProduto;
                        }
                        double media = soma / precosProdutos.size();
                ...
                case 6:
                    ...
                    int indice = nomesProdutos.indexOf(nomeRemover);
                ...
                case 7:
                    ...
                    int indiceAtualizar = nomesProdutos.indexOf(nomeAtualizar);

                    if (indiceAtualizar != -1) {
                        System.out.print("Digite o novo preço: ");
                        double novoPreco = scanner.nextDouble();
                        scanner.nextLine();
                        precosProdutos.set(indiceAtualizar, novoPreco);
...
//    public static void calcularMediaprecosProdutos() {
//        System.out.println("\n--- MÉDIA DE PREÇOS ---");
//
//        if (nomesProdutos.isEmpty()) {
//            System.out.println("Nenhum produto cadastrado!");
